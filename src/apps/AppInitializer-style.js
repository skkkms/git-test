...
// import FdpFlatUi from '~common/flat-ui/lib/flatui-all';
// import FdpFlatUi from 'fdp-flat-ui';
...
// import '~assets/css/theme-1.scss';
// import '~assets/css/foundation-tokens.scss';
// import '~assets/css/reset.css';
// import '~assets/css/common.scss';
// import '~assets/css/sui-component.scss';
// import '~assets/css/module.css';
// import '~assets/css/jqx.base.scss';
...
class AppInitializer {
  ...
  initPageLoader() {
    ...
    window.utils.install('openWindowPopup', (pageId, params = {}, title = pageId, options = {}) => {
      ...
      if (pageId) {
        url = `${systemConfig.publicPath}${systemConfig.popupUrl}#/${pageId}${queryString}`;
