<template>
  <div id="app">
    ...
    <sui-notice-controller :enable-app-notice="true" />
  </div>
</template>
...
export default {
  ...
  computed: {
    lnbShowed() {
      return this.$store.getters.isLnbShowed;
    },
    showLoadingBar() {
      console.log(this.$store.getters.httpReqCount);
      if (this.$store.getters.httpReqCount) {
