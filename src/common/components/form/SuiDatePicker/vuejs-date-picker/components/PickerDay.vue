<template>
  <div :class="[calendarClass, 'vdp-datepicker__calendar']" v-show="showDayView" :style="calendarStyle" @mousedown.prevent>
    ...
    <header>
      ...
      <span class="day__month_btn" @click="showMonthCalendar" :class="allowedToShowView('month') ? 'up' : ''">{{ isYmd ? currMonthName : currYearName }}.{{ isYmd ? currYearName : currMonthName }}</span>
      <span
        @click="isRtl ? previousMonth() : nextMonth()"
        class="next"
        :class="{'disabled': isRightNavDisabled}">&gt;</span>
    </header>
    <div class="sui-datepicker__body" :class="isRtl ? 'flex-rtl' : ''">
      <span class="cell day-header" v-for="(d, index) in daysOfWeek" :key="d.timestamp" :class="dayHeaderClass(index)">{{ d }}</span>
    ...
    <div class="sui-datepicker-button-wrap">
      <button type="button" class="btn_today" @click="onClickToday">Today</button>
      <button v-if="showConfirmButton" type="button" class="btn_confirm" @click="onClickConfirm">Apply</button>
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
     ...
     */
    onClickToday() {
      this.selectDate({"timestamp": Date.now()});
    ...
    dayHeaderClass(index) {
      return `day-header__${index}`;
    },
  },
}
