...
class CellMultiUserSelect extends GridCellBase {
  ...
  getBaseComponent() { // cell에 그려질 기본 컴포넌트를 반환
    // return utils.getComponentByName('user-multi-select');
    return utils.getComponentByName('CmpUserMultiSelect');
  }
...
export default CellMultiUserSelect;
