...
import CellPermissionCheckboxView from './CellPermissionCheckboxView';

class CellPermissionCheckbox extends GridCellBase {
  ...
  getBaseComponent() { // cell에 그려질 기본 컴포넌트를 반환
    return CellPermissionCheckboxView;
  }
...
export default CellPermissionCheckbox;
