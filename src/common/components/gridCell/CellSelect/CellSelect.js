...
import CellMultiSelectView from '~common/components/gridCell/CellMultiSelect/CellMultiSelectView';

class CellSelect extends GridCellBase {
  ...
  decoratePropsData(row, column, value, propsData) { // 컴포넌트의 초기 props 설정
    propsData.closeOnSelect = true;
    propsData.multiple = false;
  }  
