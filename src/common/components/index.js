 ...
 */
 ...
 import suiComponent from './sui/index';
 import suiLayout from './layout/index';
 ...
 import uidevContainers from './uidev/containers';
 import uidevElements from './uidev/elements';

 Vue.use(suiComponent);
 Vue.use(suiLayout);
