<template>
  <div>
    <ur-data-grid
      ...
      v-on="$listeners"
    >
      <template v-if="showRowsPerPageControl&&showMoveControl" #left-info>
...
export default {
  ...
  data() {
    return {
      mergedOptions: {
        ...
        height: DEFAULT_ROWS_PER_PAGE * DEFAULT_ROW_HEIGHT + DEFAULT_HEADER_HEIGHT,
        multiSelect: false,
        resizableColumn: true,
        msgTotal: 'Total #',
        msgSelectedCnt: 'Selected',
        msgPerPage: 'Each',
  ...
  methods: {
    ...
    onChangePageSize(v) {
      ...
      const gridHeight = v * DEFAULT_ROW_HEIGHT + DEFAULT_HEADER_HEIGHT;
