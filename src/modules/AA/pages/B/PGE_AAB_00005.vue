...
import T01 from './components/PGE_AAB_00005_T01.vue'
import T02 from './components/PGE_AAB_00005_T02.vue'

export default {
  name: 'PGE_AAB_00005', // eslint-disable-line vue/name-property-casing
  components: {
    T01,
    T02,
  },
