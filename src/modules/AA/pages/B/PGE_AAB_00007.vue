...
import T01 from './components/PGE_AAB_00007_T01.vue'
import T02 from './components/PGE_AAB_00007_T02.vue'

export default {
  name: 'PGE_AAB_00007', // eslint-disable-line vue/name-property-casing
  components: {
    T01,
    T02,
  },
