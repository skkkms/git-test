...
<script>
export default {
  name: 'PGE_AAB_00003_C05', // eslint-disable-line vue/name-property-casing
  components: {
  },
  props: {
    list: {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          value: 'subjectDescrt', text: '제목 (국문)', customValue: (v) => v ? v : '-'
        },
        {
          value: 'subjectDescrtEng', text: '제목 (영문)', customValue: (v) => v ? v : '-'
        },
        {
          value: 'contentUrl', text: '콘텐츠 URL', customValue: (v) => v ? v : '-'
        },
        {
          value: 'thumbImagUrl',
          text: '연관 상품 썸네일 이미지',
