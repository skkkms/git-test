...
<script>
export default {
  name: 'PGE_AAB_00003_C09', // eslint-disable-line vue/name-property-casing
  components: {
  },
  props: {
    list: {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          value: 'animlDescrt', text: '동물 명(국문)', customValue: (v) => v ? v : '-'
        },
        {
          value: 'animlDescrtEng', text: '동물 명(영문)', customValue: (v) => v ? v : '-'
        },
        {
          value: 'animlImagUrl',
          text: '동물이미지',
