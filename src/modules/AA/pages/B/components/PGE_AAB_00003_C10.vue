...
<script>
export default {
  name: 'PGE_AAB_00003_C10', // eslint-disable-line vue/name-property-casing
  components: {
  },
  props: {
    list: {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          value: 'menuDescrt', text: '메뉴 명(국문)', customValue: (v) => v ? v : '-'
        },
        {
          value: 'menuDescrtEng', text: '메뉴 명(영문)', customValue: (v) => v ? v : '-'
        },
        {
          value: 'menuPrice',
          text: '메뉴가격',
          customValue: v => v ? utils.numberWithCommas(v) + ' 원' : '-',
        },
        {
          value: 'menuImagUrl',
          text: '메뉴이미지',
