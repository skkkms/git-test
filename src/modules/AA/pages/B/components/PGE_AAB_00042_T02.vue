...
export default {
  name: 'PGE_AAB_00042_T02', // eslint-disable-line vue/name-property-casing
  components: {
  },
  data() {
    return {
  ...
  mounted() {
    ...
    const columnHeadGroup = [
      ...
      {
        value: 'firstRegistrationUserId', text: this.$t('MSG_TXT_FST_RGST_USR'), width: 90, customValue:v=>v?v:'-',
      },
      {
      ...
      {value: 'finalModificationUserId', text: this.$t('MSG_TIT_MDFC_USR'), customValue:v=>v?v:'-', },
    ];
