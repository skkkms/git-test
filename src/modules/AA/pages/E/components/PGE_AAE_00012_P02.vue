    ...
    <div class="comm_popup_wrap_large">
      <div class="comm_view_wrap">
        ...
        <div class="row">
          ...
          <div class="col-xs-10">
            <sui-text-field
              v-model="frame0.selectedCodeValue.code1"
              clearable              
              maxlength="50"
            />
          </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-10">
            <sui-text-field
              v-model="frame0.selectedCodeValue.code2"
              clearable              
              maxlength="50"
            />
          </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-10">
            <sui-text-field
              v-model="frame0.selectedCodeValue.code3"
              clearable             
              maxlength="50"
            />
          </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-10">
            <sui-text-field
              v-model="frame0.selectedCodeValue.code4"
              clearable              
              maxlength="50"
            />
          </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-10">
            <sui-text-field
              v-model="frame0.selectedCodeValue.code5"
              clearable              
              maxlength="50"
            />
          </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-10">
            <sui-text-field
              v-model="frame0.selectedCodeValue.code6"
              clearable              
              maxlength="50"
            />
          </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-10">
            <sui-text-field
              v-model="frame0.selectedCodeValue.code7"
              clearable              
              maxlength="50"
            />
          </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-10">
            <sui-text-field
              v-model="frame0.selectedCodeValue.code8"
              clearable              
              maxlength="50"
            />
          </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-10">
            <sui-text-field
              v-model="frame0.selectedCodeValue.code9"
              clearable              
              maxlength="50"
            />
          </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-10">
            <sui-text-field
              v-model="frame0.selectedCodeValue.code10"
              clearable              
              maxlength="50"
            />
          </div>
        ...
        >
          ...
          <div class="col-xs-10">
            ...
            <cmp-user-name-link
              :pageId="pageId"
              :displayType="'1'"
              :displayLanguageId="frame0.selectedCodeValue.modificationDisplayLanguageId"
              :loginId="frame0.selectedCodeValue.modificationLoginId"
              :knoxId="frame0.selectedCodeValue.modificationKnoxId"
              :userId="frame0.selectedCodeValue.finalModificationUserId"
              :userName="frame0.selectedCodeValue.modificationUserName"
              :userGlobalName="frame0.selectedCodeValue.modificationUserGlobalName"
              :departmentName="frame0.selectedCodeValue.modificationDepartmentName"
              :departmentEnglishName="frame0.selectedCodeValue.modificationDepartmentGlobalName"
              :type="'link'"
            />
            -->
...
export default {
  name: 'PGE_AAE_000012_P02', // eslint-disable-line vue/name-property-casing
   components: {
    MlngEditor
  },
  extends: BasePage,
  ...
  methods: {
    ...
    onClickBtnSave() {
      ...
      const dataParams = {
        ...
        deleteYn: 'N',
        code1: this.frame0.selectedCodeValue.code1,
        code2: this.frame0.selectedCodeValue.code2,
        code3: this.frame0.selectedCodeValue.code3,
        code4: this.frame0.selectedCodeValue.code4,
        code5: this.frame0.selectedCodeValue.code5,
        code6: this.frame0.selectedCodeValue.code6,
        code7: this.frame0.selectedCodeValue.code7,
        code8: this.frame0.selectedCodeValue.code8,
        code9: this.frame0.selectedCodeValue.code9,
        code10: this.frame0.selectedCodeValue.code10,
      };
    ...
    selectPrtsCodeVldList(sCodeId) {
      http.request(this.pageId, 'DTS_AAI_00017', {
        path: {
          'code-id': sCodeId || '',
        },
      }).then(res => {
    ...
    selectDetail() {
      ...
      // 수정화면 (코드 조회)
      http.request(this.pageId, 'DTS_AAI_00013', {
        path: {
        ...
        this.frame0.selectedCodeValue.code1 = res.data.code1;
        this.frame0.selectedCodeValue.code2 = res.data.code2;
        this.frame0.selectedCodeValue.code3 = res.data.code3;
        this.frame0.selectedCodeValue.code4 = res.data.code4;
        this.frame0.selectedCodeValue.code5 = res.data.code5;
        this.frame0.selectedCodeValue.code6 = res.data.code6;
        this.frame0.selectedCodeValue.code7 = res.data.code7;
        this.frame0.selectedCodeValue.code8 = res.data.code8;
        this.frame0.selectedCodeValue.code9 = res.data.code9;
        this.frame0.selectedCodeValue.code10 = res.data.code10;
      }).catch(error => {
        console.log(error);
      });
