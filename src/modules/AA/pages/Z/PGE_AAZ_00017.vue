    ...
    <sui-page-contents>
      ...
      >
        ...
        >
          ...
          <!-- E :: 일별 가상대기 예약관리(세부현황) 탭 메뉴-->

          <!-- S :: 일별 가상대기 예약관리(세부현황) 테이블-->
          <template>
            <ur-data-grid
              ref="grid"
              :headers="columns"
...
export default {
  name: 'PGE_AAZ_00017', // eslint-disable-line vue/name-property-casing
  components: {
  },
  data() {
    return {

      // 시설 카테고리, Zone 구분 드랍다운 초기값
      valueD1: '1',
      valueD2: '1',
      ...
      columns: [
        ...
        { value: 'value12', text: '가상대기 여부', width: 200 },
        {
          value: 'value5',
          text: '오픈 시간',
          width: 120,
      ...
      list: [
        {
          value1: '2022-10-13', value2: '', value3: '어트랙션, 엔터테이먼트', value4: '유러피안 어드벤처', value5: '10:00', value6: '21:00', value7: '-', value8: '금일종료', value9: '30', value10: '1,200', value11: '-', value12: '일반형',
        },
      ],
