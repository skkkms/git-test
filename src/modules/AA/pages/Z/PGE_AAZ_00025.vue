...
import P01 from './components/PGE_AAZ_00025_P01.vue'

export default {
  name: 'PGE_AAZ_00025', // eslint-disable-line vue/name-property-casing
  components: {
    P01,
  },
  data() {
    return {
      ...
      list: [
        {
          value1: '999', value2: '어린이날', value3: 'Y', value4: '1', value5: '추천코스', value6: '코스', value7: '1~4세, 여유와 힐링 / 부모님, 여유와 힐링', value8: '전 / 중', value9: 'T1 / T2 / T3 / T4 / T5', value10: '1', value11: '국문',
        },
      ],
