  ...
  <sui-page class="custom_page">
    ...
    <sui-page-contents>
      ...
      <ur-form-box toggleable>
        ...
        >
          <ur-text-field
            value="아직 스마트줄서기 이용을 안하셨네요. 스마트줄서기를 해보세요!"
            style="width: 100%; height: auto;"
          />
        </ur-form-item>
        <ur-form-item
        ...
        >
          <ur-text-field
            value="https://www.everland.com/web/everland/now/news/122"
...
export default {
  name: 'PGE_AAZ_00054', // eslint-disable-line vue/name-property-casing
  components: {
    P01,
  },
  data() {
