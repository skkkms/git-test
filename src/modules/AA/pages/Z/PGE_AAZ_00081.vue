    ...
    <sui-page-contents>
      ...
      <ur-form-box toggleable>
        ...
        >
          ...
          <div class="col_img_wrap pb4">
            <span class="guid_txt">
              * 이미지 : 624 x 244 / 파일 규격 : 15MB 미만 jpg, png, gif
            </span>
          </div>
          <div class="col_img_wrap pb4">
            <div class="col_item_img">
...
export default {
  name: 'PGE_AAZ_00081', // eslint-disable-line vue/name-property-casing
  components: {
    P01,
    P02,
  },
  data() {
    return {
      ...
      columnsT1: [
        ...
        },
        {
          ...
          component: {
            ...
            template: '<div><ur-dropdown class="pr10" v-model="T1D1" :items="radioWrapper" :rules="rules" /></div>',
          },
        },
        {
          text: '미션 분류 (2)',
          ...
          component: {
            ...
            template: '<div><ur-dropdown class="pr10" v-model="T1D2" :items="radioWrapper" :rules="rules" /></div>',
          },
        },
        {
          text: '미션 명',
          ...
          component: {
            ...
            template: '<div><ur-text-field class="comp_spacing2" value="" placeholder="메시지가 가려집니다(다른 컴포넌트도)" :rules="rules" style="width:100%; height:auto;"/></div>',
          },
        },
        {
          text: '달성 조건',
          ...
          width: 400,
          component: {
            // 인라인 class="error_message_row" 추가 필요
            template: '<div class="error_message_row"><ur-text-field value="" style="width:90%; height:auto;" class="pr10"/><ur-icon-button icon="search" icon-type="line" color="primary"/></div>',
          },
        },
        {
          text: '사용 여부',
          ...
          component: {
            ...
            <ur-radio-wrapper
              ...
              :rules="rules"
            >
              <ur-radio value="Radio01" sm> Y </ur-radio>
              <ur-radio value="Radio02" sm> N </ur-radio>
            <ur-radio-wrapper>
            </div>`,
          },
        },
      ...
      listT1: [
        {
          value1: '1', value2: '', value3: '', value4: '아래 validation이 가려지고 있습니다.', value5: '', value6: '',
        },
        {
          value1: '1', value2: '', value3: '', value4: '아래 validation이 가려지고 있습니다.', value5: '', value6: '',
        },
      ...
      columnsT2: [
        {
          ...
          required: true,
          component: {
            template: '<div><ur-text-field class="pr10" value="" mask="number"/></ur-text-field></div>',
          },
        },
        {
          text: '뱃지 분류',
          ...
          required: true,
          component: {
            template: '<div><ur-dropdown class="pr10" v-model="valueT2D1" :items="itemsT2D1"/></div>',
          },
        },
        {
          text: '뱃지 명',
          ...
          required: true,
          component: {
            template: '<div><ur-text-field class="pr10" value=""/></div>',
          },
        },
        {
          text: '뱃지 설명',
          ...
          required: true,
          component: {
            template: '<div><ur-text-field class="pr10" value="" style="width: 100%;"/></div>',
          },
        },
        {
          text: '벳지 비활성화 이미지',
