...
<script>
import P02 from './PGE_AAZ_00004_P02.vue'

export default {
  name: 'PGE_AAZ_00004_P01', // eslint-disable-line vue/name-property-casing
  components: {
    P02,
  },
  data() {
