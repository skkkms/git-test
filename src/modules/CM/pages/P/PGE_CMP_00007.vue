...
export default {
  name: 'PGE_CMP_00007', // eslint-disable-line vue/name-property-casing
  extends: BasePage,
  props: {
    closePagePopup: {
      type: Function,
  ...
  data() {
    return {
      ...
      displayStartDT: '',
      displayFinishDT: '',
      isThisLayerPopup: this.closePagePopup !== null,
      isThisWindowPopup: this.closePagePopup === null,      
    };
  },
  computed: {},
  watch: {},
