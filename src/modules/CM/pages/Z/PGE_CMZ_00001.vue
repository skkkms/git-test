...
import p01 from './components/PGE_CMZ_00001_P01';
import p02 from './components/PGE_CMZ_00001_P02';
import p03 from './components/PGE_CMZ_00001_P03';


export default {
  name: 'PGE_CMZ_00001', // eslint-disable-line vue/name-property-casing
  components: {
    p01,
    p02,
    p03,
  ...
  methods: {
    ...
    searchExcelAndDownload() {
      ...
      http.request(this.$options.name, 'DTS_CMZ_00153', {
        query: queryParams,
      }).then(res => {
        ...
        const sExcelName = `codeMgt_${sToday}.xlsx`;
    ...
    searchMaster() {
      ...
      http.request(this.$options.name, 'DTS_CMZ_00002', {
        query: queryParams,
      }).then(res => {
    ...
    deleteMaster() {
      ...
      http.request(this.$options.name, 'DTS_CMZ_00017', {
        path: {},
        data: dataParams,
      }).then(() => {
        this.searchMaster();
    ...
    deleteDetail() {
      ...
      http.request(this.$options.name, 'DTS_CMZ_00018', {
        path: {},
        data: dataParams,
      }).then(() => {
    ...
    restoreMaster() {
      ...
      http.request(this.$options.name, 'DTS_CMZ_00169', {
        data: dataParams,
        path: {
    ...
    restoreDetail() {
      ...
      http.request(this.$options.name, 'DTS_CMZ_00171', {
        data: dataParams,
        path: {
          'code-id': dataParams.codeId,
    ...
    discardMaster() {
      ...
      http.request(this.$options.name, 'DTS_CMZ_00170', {
        data: dataParams,
        path: {
          'code-id': dataParams.codeId,
        },
    ...
    discardDetail() {
      ...
      http.request(this.$options.name, 'DTS_CMZ_00172', {
        data: dataParams,
        path: {
          'code-id': dataParams.codeId,
          'code-val': dataParams.codeValidityValue,
