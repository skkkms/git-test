    ...
    <div class="comm_popup_wrap_large">
      <div class="comm_view_wrap">
        ...
        <div class="row">
          ...
          <div class="col-xs-7">
            <sui-text-field
              v-model="selectedRowData.tempCdstType"
              placeholder="Input text"
              :disabled="true"
            />
          </div>
...
const PARENT_PAGE_NAME = 'PGE_CMZ_00001';
export default {
  name: 'PGE_CMZ_00001_P03', // eslint-disable-line vue/name-property-casing
  extends: BasePage,
  props: {
    selectedRowData: {
      type: Object,
  ...
  methods: {
    ...
    onClickBtnSelect() {
      ...
      http.request(PARENT_PAGE_NAME, 'DTS_CMZ_00021', { // dataservices reg.
        path: {},
        data: dataParams,
      }).then(res => {
        this.$emit('save');
    ...
    selectSubDetail(sCodeId) {
      http.request(PARENT_PAGE_NAME, 'DTS_CMZ_00020', {
        query: {
          codeId: sCodeId || '',
