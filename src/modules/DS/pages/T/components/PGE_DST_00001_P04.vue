  ...
  <div>
    <div class="comm_popup_wrap_large">
      ...
      <div class="comm_view_wrap">
        ...
        <div class="row">
          <div class="col-xs-1">
            <sui-input-label :label="$t('MSG_TXT_DOM_CNTN')" />
          </div>
          <div class="col-xs-11">
            <textarea
...
export default {
  ...
  mounted() {
    ...
    // this.currentSelected = this.searchFrame.dataType[this.dataTypeValue];
  },
  ...
  methods: {
    ...
    submitRequest(event) {
      // utils.isEmpty
      if (this.domainApplyContent.trim() && this.domainContent.trim()) {
        // utils.confirm(this.$t('MSG_ALT_WANT_APPY'), this.$t('MSG_TXT_YES'), this.$t('MSG_TXT_NO') , this.submitRequestApi, () => {});
        // utils.messageBox('confirm', this.$t('MSG_ALT_WANT_APPY'), null, this.submitRequestApi);
    ...
    submitRequestApi(approvalData) {
      const queryParams = {
        ...
        finalModificationUserId: this.$store.getters.userInfo.knoxId,
        firstRegistrationUserId: this.$store.getters.userInfo.knoxId,
        finalModificationProgramId: 'PGE_DST_00001',
        firstRegistrationProgramId: 'PGE_DST_00001',
        approvalData: null,
      };
      ...
      http.request('PGE_DST_00001', 'DTS_DST_00006', {
        path: {
    ...
    //       // 결재 제목
    //       title: `${this.$t('MSG_TXT_DST_APRV_PRFX')} ${this.$t('MSG_TXT_DOM')} ${this.$t('MSG_TXT_DEL')} (${this.$t('MSG_TXT_STD_LGC_NM')} : ${this.domainPhysName})`,
    //       titleReadonly: true,
